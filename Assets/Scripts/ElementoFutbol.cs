...
public class ElementoFutbol : MonoBehaviour {
			...
			if (estructuraFrase[1] == false && estructuraFrase [0] == true && posicionOcupada [0] == true) {
				...
				if (estructuraFrase [2] == false && posicionOcupada [0] == true && posicionOcupada [1] == true) {
					...
					if (elemento == "do") {
						...
						elementoInstanciado = Instantiate (palabras[5], new Vector3 ((float)(-0.65), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
	...
	void comprobarPosicionAfirmativa (){
		...
		if (elementoPulsado [0] == "yes" && posicionOcupada [0] == false) {
			...
			if (elementoPulsado [1] == "i" && posicionOcupada [0] == true && posicionOcupada [1] == false) {
