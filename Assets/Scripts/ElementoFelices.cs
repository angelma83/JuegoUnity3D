...
public class ElementoFelices : MonoBehaviour {
		...
		if (estructuraFrase[0] == false && posicionOcupada [0] == false) {
			...
			if (estructuraFrase[1] == false && estructuraFrase [0] == true && posicionOcupada [0] == true) {
				...
				if (elemento == "isnot") {
					elementoPulsado [1] =elemento;
					accesoSonidos.impactoBoton ();
					elementoInstanciado = Instantiate (palabras [1], new Vector3 ((float)(-0.8), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
					comprobarPosicionAfirmativa ();
				...
				if (estructuraFrase [2] == false && posicionOcupada [0] == true && posicionOcupada [1] == true) {
					...
					if (elemento == "isnot") {
						elementoPulsado [2] = elemento;
						accesoSonidos.impactoBoton ();
						elementoInstanciado = Instantiate (palabras[1], new Vector3 ((float)(-0.1), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
						comprobarPosicionAfirmativa ();
					}
					if (elemento == "canot") {
						elementoPulsado [2] = elemento;
	...
	void comprobarPosicionAfirmativa (){
		...
		if (elementoPulsado [0] == "yes" && posicionOcupada [0] == false) {
			...
			if (elementoPulsado [1] == "they" && posicionOcupada [0] == true && posicionOcupada [1] == false) {
				...
				if (elementoPulsado [2] == "are" && posicionOcupada [1] == true && posicionOcupada [2] == false) {
