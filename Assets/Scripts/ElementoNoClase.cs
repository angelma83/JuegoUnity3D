...
public class ElementoNoClase : MonoBehaviour {
			...
			if (estructuraFrase[1] == false && estructuraFrase [0] == true && posicionOcupada [0] == true) {
				...
				if (estructuraFrase [2] == false && posicionOcupada [0] == true && posicionOcupada [1] == true) {
					...
					if (elemento == "arenot") {
						...
						elementoInstanciado = Instantiate (palabras[5], new Vector3 ((float)(-0.05), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
	...
	void comprobarPosicionAfirmativa (){
		...
		if (elementoPulsado [0] == "no" && posicionOcupada [0] == false) {
			...
			if (elementoPulsado [1] == "they" && posicionOcupada [0] == true && posicionOcupada [1] == false) {
				...
				if (elementoPulsado [2] == "arenot" && posicionOcupada [1] == true && posicionOcupada [2] == false) {
