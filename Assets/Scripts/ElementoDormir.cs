...
public class ElementoDormir : MonoBehaviour {
		...
		if (estructuraFrase[0] == false && posicionOcupada [0] == false) {
			...
			if (estructuraFrase[1] == false && estructuraFrase [0] == true && posicionOcupada [0] == true) {
				...
				if (elemento == "arenot") {
					elementoPulsado [1] =elemento;
					accesoSonidos.impactoBoton ();
					elementoInstanciado = Instantiate (palabras [1], new Vector3 ((float)(-0.9), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
					comprobarPosicionAfirmativa ();
				...
				if (estructuraFrase [2] == false && posicionOcupada [0] == true && posicionOcupada [1] == true) {
					...
					if (elemento == "arenot") {
						elementoPulsado [2] = elemento;
						accesoSonidos.impactoBoton ();
						elementoInstanciado = Instantiate (palabras[1], new Vector3 ((float)(-0.3), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
						comprobarPosicionAfirmativa ();
					}
					if (elemento == "donot") {
						elementoPulsado [2] = elemento;
						accesoSonidos.impactoBoton ();
						elementoInstanciado = Instantiate (palabras[2], new Vector3 ((float)(-0.5), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
						comprobarPosicionAfirmativa ();
					}
					if (elemento == "can") {
						elementoPulsado [2] = elemento;
					...
					if (elemento == "doesnot") {
						...
						elementoInstanciado = Instantiate (palabras[5], new Vector3 ((float)(-0.3), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
					...
					if (elemento == "isnot") {
						elementoPulsado [2] = elemento;
						accesoSonidos.impactoBoton ();
						elementoInstanciado = Instantiate (palabras[7], new Vector3 ((float)(-0.5), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
						comprobarPosicionAfirmativa ();
					}
					if (elemento == "yes") {
						elementoPulsado [2] = elemento;
	...
	void comprobarPosicionAfirmativa (){
		...
		if (elementoPulsado [0] == "no" && posicionOcupada [0] == false) {
			...
			if (elementoPulsado [1] == "it" && posicionOcupada [0] == true && posicionOcupada [1] == false) {
				...
				if (elementoPulsado [2] == "doesnot" && posicionOcupada [1] == true && posicionOcupada [2] == false) {
