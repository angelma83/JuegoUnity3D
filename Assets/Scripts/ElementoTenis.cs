...
public class ElementoTenis : MonoBehaviour {
		...
		if (estructuraFrase[0] == false && posicionOcupada [0] == false) {
			...
			if (estructuraFrase[1] == false && estructuraFrase [0] == true && posicionOcupada [0] == true) {
				...
				if (elemento == "he") {
					elementoPulsado [1] = elemento;
					accesoSonidos.impactoBoton ();
					elementoInstanciado = Instantiate (palabras[5], new Vector3 ((float)(-1), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
					comprobarPosicionAfirmativa ();
				} 
				if (elemento == "does") {
					elementoPulsado [1] = elemento;
				...
				if (estructuraFrase [2] == false && posicionOcupada [0] == true && posicionOcupada [1] == true) {
					...
					if (elemento == "isnot") {
						elementoPulsado [2] = elemento;
						accesoSonidos.impactoBoton ();
						elementoInstanciado = Instantiate (palabras[1], new Vector3 ((float)(0.2), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
						comprobarPosicionAfirmativa ();
					}
					if (elemento == "is") {
						elementoPulsado [2] = elemento;
					...
					if (elemento == "he") {
						...
						elementoInstanciado = Instantiate (palabras[5], new Vector3 ((float)(-0.5), (float)(-0.7), (float)(1.6)), Quaternion.identity); 
	...
	void comprobarPosicionAfirmativa (){
		...
		if (elementoPulsado [0] == "yes" && posicionOcupada [0] == false) {
			...
			if (elementoPulsado [1] == "he" && posicionOcupada [0] == true && posicionOcupada [1] == false) {
				...
				if (elementoPulsado [2] == "does" && posicionOcupada [1] == true && posicionOcupada [2] == false) {
